...
export const GUIDES = [
  ...
  },
  {
    ...
    summary:
      'Rack Unit (позначається U або RU) — стандартна одиниця висоти обладнання в стійці. 1U дорівнює 44,45 мм (1,75 дюйма): це значення визначає стандарт EIA-310 для 19-дюймових стійок, і виробники 10-дюймових стійок його дотримуються, хоча самі 10 дюймів окремим стандартом не описані. Висота обладнання рахується множенням: 2U = 88,9 мм, 3U = 133,35 мм, 4U = 177,8 мм, 5U = 222,25 мм.',
    datePublished: PUBLISHED,
    dateModified: PUBLISHED,
    ...
    faq: [
      {
        ...
        answer:
          '1U = 44,45 мм (1,75 дюйма). Стандарт EIA-310 закріплює це значення для 19-дюймових стійок; виробники 10-дюймових стійок використовують той самий крок, тому висота юніта на практиці однакова в обох форматах.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Виробники залишають технологічний зазор, щоб сусідні пристрої не тиснули один на одного і їх можна було вийняти. Тому пристрій на 1U має висоту трохи меншу за 44,45 мм — це нормальна практика, а не дефект.',
      },
      {
